...
references:
  ...
  - name: "JAGUAR"
    url: "http://www.example.com"
thumbnail: "img/works/{{ .Name }}/thumbnail.jpg"
---

{{< figure src="../img/works/{{ .Name }}/key.jpg" alt="{{ .Name }}" >}}
...
{{< figure class="w-screen" src="../img/works/{{ .Name }}/sub.jpg" alt="{{ .Name }}" >}}
...
{{< figure src="../img/works/{{ .Name }}/sub.jpg" alt="{{ .Name }}" >}}
